...
class ExtremeModeFragment : Fragment(), PlayerNameListener {

    private var _binding: FragmentExtremeModeBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentExtremeModeBinding.inflate(inflater, container, false)
